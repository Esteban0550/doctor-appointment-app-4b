...
<ul class="space-y-2 font-medium">
    ...
    <li>
        ...
        @else
            ...
            @else
                <a href="{{ $link['href'] }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-blac hover:bg-gray-100 dark:hover:bg-gray-700 group {{ $link['active'] ? 'bg-gray-100' : '' }}">
