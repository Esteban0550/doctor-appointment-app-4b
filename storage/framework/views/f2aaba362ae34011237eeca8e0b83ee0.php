<div class="border border-gray-200 rounded-lg bg-white shadow-sm">
    <div class="flex flex-col gap-4 p-4 md:flex-row md:items-center md:justify-between border-b border-gray-200">
        ...
        <div class="text-sm text-gray-500">
            <!--[if BLOCK]><![endif]--><?php if($patients->total()): ?>
                Mostrando <?php echo e($patients->firstItem()); ?>–<?php echo e($patients->lastItem()); ?> de <?php echo e($patients->total()); ?> pacientes
            <?php else: ?>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $patients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $patient): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                            <?php echo e($patient->bloodType?->name ?? '-'); ?>

                        </td>
                        <td class="px-6 py-4 text-sm text-gray-900">
                            <?php echo e($patient->allergies ? \Illuminate\Support\Str::limit($patient->allergies, 50) : '-'); ?>

                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <div class="flex items-center justify-end space-x-2">
                                <a href="<?php echo e(route('admin.patients.edit', $patient)); ?>"
...
<?php /**PATH C:\Users\esteb\OneDrive\Desktop\doctor-appointment-app-4b\resources\views/livewire/admin/datatables/patient-table.blade.php ENDPATH**/ ?>